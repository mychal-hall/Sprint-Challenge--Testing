...
# describe creates a block of tests that are related. It's great for organizing your tests into groups. Is nestable.

# it() is an alias of test() which is a method that runs a test. It is good for running tests.

1. What is the point of `Test Driven Development`? What do you think about this approach?

# TDD is just that. Development in small batches driven by specific tests. It ensures that your code passes the definitions of the requested software.

# I have things to say about this but won't type it all here.
